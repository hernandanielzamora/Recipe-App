...
> Recipe App is a Ruby on Rails application that allows a user to login to a food recipe page where the user can perform actions based on authorization like, add foods and recipes, generate a shopping list, etc.
